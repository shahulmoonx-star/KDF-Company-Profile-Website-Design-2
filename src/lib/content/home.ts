...
const homePageByLocale: Record<Locale, HomePage> = {
  en: {
    ...
    solutions: {
      ...
      items: [
        ...
        },
        {
          ...
          image: "/images/solutions-manufacturing-supply.webp",
        ...
        },
        {
          ...
          image: "/images/solutions-technical-services.webp",
        ...
        },
        {
          ...
          image: "/images/solutions-water-treatment.webp",
    ...
    capability: {
      ...
      image: "/images/capability-manufacturing-facility.webp",
    ...
    sustainability: {
      ...
      pillars: [
        {
          id: "treat", group: "Production Technologies", image: "/images/sustainability-treat.webp", imageAlt: "Chemical injection metering pump dosing production treatment fluid",
          title: "Treat",
        ...
        {
          id: "protect", group: "Production Technologies", image: "/images/sustainability-protect.webp", imageAlt: "Coated steel pipelines running toward the horizon at sunset",
          title: "Protect",
        ...
        {
          id: "assure", group: "Production Technologies", image: "/images/sustainability-assure.webp", imageAlt: "Illuminated wellhead valve assembly against a dusk sky",
          title: "Assure",
        ...
        {
          id: "emissions", group: "Sustainability", image: "/images/sustainability-emissions.webp", imageAlt: "Elevated view across an industrial facility rooftop and stacks",
          title: "Emissions",
          body: "Reduction targets set across Scope 1, 2 and 3, reported openly rather than summarised.",
        },
        {
          id: "environment", group: "Sustainability", image: "/images/sustainability-environment.webp", imageAlt: "Water treatment basin with a still reflective surface",
          title: "Environment",
          body: "Spill prevention, energy reduction, emissions control and responsible waste handling across every site.",
        },
        {
          id: "people", group: "Sustainability", image: "/images/sustainability-people-local-content.webp", imageAlt: "Engineers reviewing a schematic together in a training room",
  ...
  ar: {
    ...
    sustainability: {
      ...
      pillars: [
        {
          id: "treat", group: "تقنيات الإنتاج", image: "/images/sustainability-treat.webp", imageAlt: "مضخة جرعات لحقن مواد كيميائية لمعالجة الإنتاج",
          title: "Treat",
          body: "حلول مصمّمة لدعم معالجة الإنتاج وتحسين الكفاءة التشغيلية.",
          tags: ["كاسرات المستحلبات", "مروّقات المياه", "محسّنات التدفق"],
        },
        {
          id: "protect", group: "تقنيات الإنتاج", image: "/images/sustainability-protect.webp", imageAlt: "أنابيب فولاذية مطلية تمتد نحو الأفق عند الغروب",
          title: "Protect",
        ...
        {
          id: "assure", group: "تقنيات الإنتاج", image: "/images/sustainability-assure.webp", imageAlt: "تجميعة صمام رأس بئر مضاءة عند الغسق",
          title: "Assure",
        ...
        {
          id: "emissions", group: "الاستدامة", image: "/images/sustainability-emissions.webp", imageAlt: "منظر علوي لسطح منشأة صناعية ومداخنها",
          title: "الانبعاثات",
          body: "أهداف خفض محددة عبر النطاقات الأول والثاني والثالث، مع إفصاح شفاف لا مجرد ملخّص.",
        },
        {
          id: "environment", group: "الاستدامة", image: "/images/sustainability-environment.webp", imageAlt: "حوض معالجة مياه بسطح ساكن عاكس",
          title: "البيئة",
          body: "منع الانسكابات وخفض استهلاك الطاقة والتحكم في الانبعاثات وإدارة النفايات بمسؤولية في كل موقع.",
        },
        {
          id: "people", group: "الاستدامة", image: "/images/sustainability-people-local-content.webp", imageAlt: "مهندسون يراجعون مخططًا معًا في قاعة تدريب",
